...
@application.route('/api/create/<player_name>', methods=['POST'])
...
@application.route('/api/join/<game_id>/<player_name>', methods=['POST'])
def join_game(game_id, player_name):
  player_id = helpers.random_id()
  success = store.join_game(game_id, player_id, player_name)
  return flask.jsonify({'playerId': player_id, 'success': success})

@application.route('/api/start/<game_id>/<player_id>/<player_name>', methods=['POST'])
...
@application.route('/api/propose/<quest_id>/<player_id>/<player_name>', methods=['POST'])
...
@application.route('/api/proposal/vote/<quest_id>/<player_id>/<player_name>/<vote>', methods=['POST'])
...
@application.route('/api/quest/vote/<quest_id>/<player_id>/<player_name>/<vote>', methods=['POST'])
...
@application.route('/api/state/<game_id>/<player_id>')
